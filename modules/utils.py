...
class Settings():
    def __init__(self):
        ...
        self.CAM_INTERVAL = 300  # ms
        self.ALIGN_INTERVAL = 1000  # ms
        self.VIEWER_INTERVAL = 500  # ms
        self.OUTPUT_INTERVAL = 15000
        ...
        self.M2X = 3
        self.M2Y = 4
        self.MOTOR_TYPE = 2  # tiny
        self.MOTOR_VELOCITY = 1000  # was 1750
        self.MOTOR_ACCELERATION = 10_000  # was 100_000
        self.AMM_STEPS_1 = 100
        self.AMM_STEPS_2 = 500
        self.GAIN = 0.15
        self.ALIGNMENT_THRESHOLD = 0.5
        self.MIN_MOVEMENT_THRESHOLD = 0.2
        self.INTENSITY_THRESHOLD = 0.4
        self.SAMPLES = 5  # for both aligning and acquiring motion matrix
        self.MOTION_MATRIX_CONSTRAINT = np.array([
            [1, 0, 0, 0],
            [0, 1, 0, 0],
            [1, 0, 1, 0],
            [0, 1, 0, 1]])
    ...
    def update(self, newdata):
        """Provided new data is a dictionary"""
        for key, value in newdata.items():
            setattr(self, key, value)

    def save(self, filename='./config_data/settings.json'):
        output_str = jp.encode(self, indent=4)
        with open(filename, 'w+') as f:
            f.write(output_str)

    @staticmethod
    def load(filename='./config_data/settings.json'):
